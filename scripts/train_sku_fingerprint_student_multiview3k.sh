...
#STUDENT_CKPT_OUT="${STUDENT_CKPT_OUT:-$PROJECT_ROOT/checkpoints/sku_fingerprint_student/sku_fingerprint_student_baseline5_ft_bestshot_bs64_text0p1_unlock2_ep6_lr3e-4_e100_both_txtimg_sd_sub3k_nv4.pt}"
STUDENT_CKPT_OUT="${STUDENT_CKPT_OUT:-$PROJECT_ROOT/checkpoints/sku_fingerprint_student/sku_fingerprint_student_baseline5_ft_bestshot_bs64_text0p1_unlock2_ep6_lr3e-4_e200_both_txtimg_sd_sub3k_nv4.pt}"
...
python -m train.train_sku_fingerprint_distill \
  ...
  --wandb_run_name "student_baseline5_sd_sub3k_e200_both_txtimg"
